...
> Cost tracker compiling detailed model token usage statistics and outputting JSON dashboards.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/rag-cost-os/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-rag-cost-os.git
cd tp-rag-cost-os
```
...
```bash
kubectl port-forward deployment/tp-rag-cost-os 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── cost_tracker.ts     # Main configuration file
```
...
---
*Generated by [RAG-Cost-OS Studio](https://pradeeptalari14.github.io/portfolio/tools/rag-cost-os/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
