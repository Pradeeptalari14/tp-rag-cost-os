# 🔧 Troubleshooting Guide — RAG-Cost-OS
...
2. **Check official documentation:**
   - [GitHub Issues for this repo](https://github.com/Pradeeptalari14/tp-rag-cost-os/issues)
   - [Studio FAQ](https://pradeeptalari14.github.io/portfolio/tools/rag-cost-os/)
